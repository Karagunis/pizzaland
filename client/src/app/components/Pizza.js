    ...
    <div className="group py-2 px-4 xl:py-4 xl:px-2 rounded-xl">
      ...
      {modal && (
        <Modal
          ...
          className="bg-white w-full h-full lg:max-w-[900px] lg:max-h-[600px] lg:rounded-[18px] lg:fixed lg:top-[50%] lg:left-[50%] lg:translate-x-[-50%] lg:translate-y-[-50%] outline-none"
        >
          <div
            onClick={closeModal}
